...
export const arcPredictionMarketV4Abi = [
  ...
  { type: "event", name: "UnproposedMarketCanceled", inputs: [{ type: "uint256", name: "marketId", indexed: true }] },
  { type: "function", name: "aiAttestationSigner", stateMutability: "view", inputs: [], outputs: [{ type: "address" }] },
  { type: "function", name: "proposalGracePeriod", stateMutability: "view", inputs: [], outputs: [{ type: "uint256" }] },
  {
    type: "function",
    name: "createMarket",
    stateMutability: "nonpayable",
  ...
  { type: "function", name: "cancelUnproposedMarket", stateMutability: "nonpayable", inputs: [{ type: "uint256", name: "marketId" }], outputs: [] },
  {
    type: "function",
    name: "getMarketTerms",
    stateMutability: "view",
